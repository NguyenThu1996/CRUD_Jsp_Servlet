...
<body>
	<script type="text/javascript">
		function validateform(e) {
			debugger;
			var name = document.edituser.fullname.value;
			var age = document.edituser.age.value;
			var address = document.edituser.address.value;
			debugger;
			if (name == null || name == "") {
			...
			Swal.fire('Edit Success!', 'You have successfully Edited!!',
					'success');
		}
	</script>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-9">
				<form action="EditUser" method="POST" name="edituser"
						...
						<div class="input-container">
							<div class="row">
								<span class="req-input"> <span class="input-status"
									...
									type="text" data-min-length="8" placeholder="Id" name="id"
							...
							<div class="row">
								<span class="req-input"> <span class="input-status"
									...
									placeholder="Age" name="age" value="<%= user.getAge()%>">
								</span>
							</div>
							<div class="row">
								<span class="req-input"> <span class="input-status"
									data-toggle="tooltip" data-placement="top"
									title="Please Input gmail."> </span> <input type="text"
									placeholder="Gmail" name="gmail" value="<%= user.getGmail() %>">
								</span>
							</div>
							<div class="row">
								<span class="req-input"> <span class="input-status"
									...
									placeholder="Address" name="address" value="<%=user.getAddress()%>">
								</span>
							</div>
							<div class="row">
								<span class="req-input"> <span class="input-status"
									...
									placeholder="username" name="username" value="<%=user.getUsername()%>" readonly>
								</span>
							</div>
							<div class="row">
								<span class="req-input"> <span class="input-status"
									data-toggle="tooltip" data-placement="top"
									title="Please Input Your Password"> </span> <input type="password"
									placeholder="Password" name="password" value="<%= user.getPassword()%>" readonly >
								</span>
							</div>
